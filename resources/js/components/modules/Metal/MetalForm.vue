<template>
  <v-container v-if="item" fluid class="pa-1 ma-0">
    ...
    <v-row class="ga-1">
      <v-text-field v-model="lf.metal_primary_classification_id" label="Primary Classification" readonly filled />
    ...
    <v-row class="ga-1">
      ...
      <v-textarea v-model="item.measurements" label="Measurements" readonly filled />
...
const item = computed(() => {
  return fields.value as TFields<'Metal'>
})

const lf = computed(() => {
  return lookupFields.value as TFields<'Metal'>
})
</script>
